...
static inline uiCanvas_t UI_ResolveCanvas(size2_t window, UICANVASPOLICY policy) {
    uiCanvas_t canvas = { .scene = { 0, 0, UI_BASE_WIDTH, UI_BASE_HEIGHT }, .window = window, .policy = policy };
