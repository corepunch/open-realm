...
R_GetModelCameraMatrix(mdxModel_t const *model, uint32_t frame, float aspect, mat4_t *output, vec3_t *root)
{
    ...
    if (camera->targetTranslation) {
        vec3_t targetTranslation = {0, 0, 0};
