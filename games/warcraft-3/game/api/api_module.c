...
jassModule_t jass_funcs[] = {
    ...
    { "TownHasMine", TownHasMine },
    { "TownHasHall", TownHasHall },
    ...
    { "SetTargetHeroes", SetTargetHeroes },
    { "SetPeonsRepair", SetPeonsRepair },
    { "SetHeroesFlee", SetHeroesFlee },
    { "SetWatchMegaTargets", SetWatchMegaTargets },
    { "SetIgnoreInjured", SetIgnoreInjured },
    { "SetHeroesTakeItems", SetHeroesTakeItems },
    { "SetUnitsFlee", SetUnitsFlee },
    { "SetGroupsFlee", SetGroupsFlee },
    { "SetSlowChopping", SetSlowChopping },
    { "SetCaptainChanges", SetCaptainChanges },
    ...
    { "ReturnGuardPosts", ReturnGuardPosts },
    ...
    { "SetDestructableOccluderHeight", SetDestructableOccluderHeight },
    { "GetDestructableOccluderHeight", GetDestructableOccluderHeight },
    ...
    { "SetUnitUserData", SetUnitUserData },
    { "GetUnitUserData", GetUnitUserData },
    ...
    { "UnitResetCooldown", UnitResetCooldown },
    { "BlzGetUnitAbilityCooldownRemaining", BlzGetUnitAbilityCooldownRemaining },
    { "BlzEndUnitAbilityCooldown", BlzEndUnitAbilityCooldown },
    { "BlzStartUnitAbilityCooldown", BlzStartUnitAbilityCooldown },
    ...
    { "GetUnitRallyPoint", GetUnitRallyPoint },
    { "GetUnitRallyUnit", GetUnitRallyUnit },
    ...
    { "GetAllyColorFilterState", GetAllyColorFilterState },
    { "SetAllyColorFilterState", SetAllyColorFilterState },
    { "GetCreepCampFilterState", GetCreepCampFilterState },
    { "SetCreepCampFilterState", SetCreepCampFilterState },
    { "EnableMinimapFilterButtons", EnableMinimapFilterButtons },
    { "EnableDragSelect", EnableDragSelect },
    { "EnablePreSelect", EnablePreSelect },
    { "EnableSelect", EnableSelect },
    { "SetReservedLocalHeroButtons", SetReservedLocalHeroButtons },
    ...
    { "HaveStoredString", HaveStoredString },
    { "FlushGameCache", FlushGameCache },
    { "FlushStoredMission", FlushStoredMission },
    { "FlushStoredInteger", FlushStoredInteger },
    { "FlushStoredReal", FlushStoredReal },
    { "FlushStoredBoolean", FlushStoredBoolean },
    { "FlushStoredUnit", FlushStoredUnit },
    ...
    { "SetAllItemTypeSlots", SetAllItemTypeSlots },
    { "SetAllUnitTypeSlots", SetAllUnitTypeSlots },
    { "SetItemTypeSlots", SetItemTypeSlots },
    { "SetUnitTypeSlots", SetUnitTypeSlots },
    { "AddItemToStock", AddItemToStock },
    { "AddItemToAllStock", AddItemToAllStock },
    { "RemoveItemFromStock", RemoveItemFromStock },
    { "RemoveItemFromAllStock", RemoveItemFromAllStock },
    { "AddUnitToStock", AddUnitToStock },
    { "AddUnitToAllStock", AddUnitToAllStock },
    { "RemoveUnitFromStock", RemoveUnitFromStock },
    { "RemoveUnitFromAllStock", RemoveUnitFromAllStock },
    ...
    { "SetAltMinimapIcon", SetAltMinimapIcon },
    ...
    /* DotA #436: shop, hero, combat, item, string, and presentation natives */
    ...
    { "GetUnitCurrentOrder", GetUnitCurrentOrder },
    ...
    { "GetItemUserData", GetItemUserData },
    { "SetItemUserData", SetItemUserData },
    ...
    { "SetImageRenderAlways", SetImageRenderAlways },
    { "SetImageConstantHeight", SetImageConstantHeight },
    { "SetImageAboveWater", SetImageAboveWater },
    { "SetImageType", SetImageType },
    { "CreateUbersplat", CreateUbersplat },
    { "DestroyUbersplat", DestroyUbersplat },
    { "ResetUbersplat", ResetUbersplat },
    { "FinishUbersplat", FinishUbersplat },
    { "ShowUbersplat", ShowUbersplat },
    { "SetUbersplatRender", SetUbersplatRender },
    { "SetUbersplatRenderAlways", SetUbersplatRenderAlways },
    { NULL },
};
