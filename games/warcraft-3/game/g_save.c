...
/* Format 35 persists hashtables, build previews, map config lifecycle, mutable Blight/Abli, reflected/attached missile, lightning state, and JASS lightning identity. */
