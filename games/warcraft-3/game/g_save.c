...
static DWORD const save_version = 33; // format version; persists hashtables, build previews, map config lifecycle, mutable Blight/Abli, and reflected missile state
