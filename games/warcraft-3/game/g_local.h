...
LPEDICT G_GetIssuedOrderTarget(LPCEDICT);
void G_ClearIssuedOrderState(LPEDICT);
BOOL G_GetActiveUnitOrder(LPCEDICT, unitOrder_t *);
BOOL G_GetQueuedUnitOrder(LPCEDICT, DWORD index, unitOrder_t *);
void G_ClearActiveUnitOrder(LPEDICT);
...
DWORD G_UnitStatusBuffCode(heroabilitystatus_t const *);
