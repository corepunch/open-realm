...
ABILITY_INFO_NIGHTELF2 = "- Dodge chance increased.";
ABILITY_INFO_NIGHTELF3 = "- Wisp form while dead.";
ABILITY_INFO_NIGHTELF4 = "- Resistant to Nature damage.";
ABILITY_INFO_ORC1 = "- May enrage, increasing strength at the cost of health.";
ABILITY_INFO_ORC2 = "- Resistant to stun and knockout effects.";
...
ABILITY_INFO_TROLL1 = "- Berserk when wounded, increasing attack and casting speed.";
ABILITY_INFO_TROLL2 = "- Regeneration increased.";
ABILITY_INFO_TROLL3 = "- Damage increased versus beasts.";
ABILITY_INFO_TROLL4 = "- Throwing Weapon skill increased.";
...
GAMETYPE_PVE = "Normal";
GAMETYPE_PVE_TEXT = "These realms allow you focus on adventuring and fighting monsters while allowing you fight other players at your own discretion.";
...
LOGIN_BADVERSION = "Unable to validate game version.  This may be caused by file corruption or the interference of another program.  Please visit www.blizzard.com/support/wow/ for more information and possible solutions to this issue.";
...
SERVER_ALERT_TITLE = "Server Alert";
SERVER_ALERT_URL = "http://www.worldofwarcraft.com/alert";
