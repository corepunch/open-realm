...
- `CharSections.dbc` classic-era layout (10 fields, 40 bytes/record): the three texture name string offsets are NOT contiguous. Field 5 is `variationIndex`, not a string offset. Correct field mapping: `0`=ID, `1`=raceID, `2`=sexID, `3`=baseSection, `4`=textureName[0], `5`=variationIndex, `6`=textureName[1], `7`=textureName[2], `8`=textureName[3], `9`=colorIndex. The `whoa-master` documents a different TBC/Wrath layout where fields 4-6 are contiguous strings; that does NOT match the classic DBC. Use fields `6+texture_index` for textures and field `9` for colorIndex when querying by variation/color.
