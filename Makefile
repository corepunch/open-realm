...
WOW_GENERATED_SRCS := $(WOW_GENERATED_DIR)/g_creatures.c $(WOW_GENERATED_DIR)/g_quests.c $(WOW_GENERATED_DIR)/g_weapons.c $(WOW_GENERATED_DIR)/g_playercreateinfo.c $(WOW_GENERATED_DIR)/g_areatrigger_teleport.c
...
$(WOW_GENERATED_DIR)/g_areatrigger_teleport.c: $(WOW_GENERATOR) $(WOW_DIR)/serverdata/areatrigger_teleport.csv
	@mkdir -p $(@D)
	@python3 $(WOW_GENERATOR) --only areatrigger_teleport --output-dir $(WOW_GENERATED_DIR)
