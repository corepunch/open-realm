...
$(eval $(call unity_lib_schema,$(GAME_WOW_LIB),$(GAME_BASE_DEPS) common/world.c $(WOW_COMMON_SRCS) $(call CSRC,$(WOW_DIR)/game) $(call CSRC,serverdata/world-of-warcraft),game-wow,$(WOW_DIR)/game serverdata/world-of-warcraft,,$(WOW_CFLAGS),common/mpq.c,-lshared $(LIBS) -lm -lz))
...
$(eval $(call unity_lib_schema,$(GAME_WOW_TEST_LIB),$(GAME_BASE_DEPS) common/world.c $(WOW_COMMON_SRCS) $(call CSRC,$(WOW_DIR)/game) $(call CSRC,serverdata/world-of-warcraft),game-wow-test,$(WOW_DIR)/game serverdata/world-of-warcraft,,$(WOW_CFLAGS) -DBZ_TESTS,common/mpq.c,-lshared $(LIBS) -lm -lz))
...
$(eval $(call test_schema,test-wow-abilities,,$(WOW_TEST_CFLAGS),$(BIN_DIR)/test_wow_abilities$(EXE_EXT),tests/test_runner.c $(WOW_TEST_DIR)/test_wow_abilities.c $(WOW_DIR)/game/g_wow.c $(WOW_DIR)/game/g_world.c $(WOW_DIR)/game/g_ai.c $(WOW_DIR)/game/m_creature.c $(WOW_DIR)/game/g_wow_gameobject.c $(WOW_DIR)/game/g_spawn.c serverdata/world-of-warcraft/wow_weapon_data.c serverdata/world-of-warcraft/wow_quest_data.c common/mpq.c $(call CSRC,shared),-lm -lz,))
$(eval $(call test_schema,test-wow-game,,$(WOW_TEST_CFLAGS),$(BIN_DIR)/test_wow_game$(EXE_EXT),tests/test_runner.c $(WOW_TEST_DIR)/test_wow_game.c $(WOW_DIR)/game/g_wow.c $(WOW_DIR)/game/g_ui.c $(WOW_DIR)/game/g_world.c $(WOW_DIR)/game/g_ai.c $(WOW_DIR)/game/m_creature.c $(WOW_DIR)/game/g_wow_gameobject.c $(WOW_DIR)/game/g_spawn.c serverdata/world-of-warcraft/wow_weapon_data.c serverdata/world-of-warcraft/wow_quest_data.c common/mpq.c $(call CSRC,shared),-lm -lz,))
$(eval $(call test_schema,test-wow-entities,,$(WOW_TEST_CFLAGS),$(BIN_DIR)/test_wow_entities$(EXE_EXT),tests/test_runner.c $(WOW_TEST_DIR)/test_wow_entities.c $(WOW_DIR)/game/g_wow.c $(WOW_DIR)/game/g_world.c $(WOW_DIR)/game/g_ai.c $(WOW_DIR)/game/m_creature.c $(WOW_DIR)/game/g_wow_gameobject.c $(WOW_DIR)/game/g_spawn.c serverdata/world-of-warcraft/wow_weapon_data.c serverdata/world-of-warcraft/wow_quest_data.c common/mpq.c $(call CSRC,shared),-lm -lz,))
