...
$(eval $(call unity_lib_schema,$(GAME_WOW_LIB),$(GAME_BASE_DEPS) common/world.c $(WOW_COMMON_SRCS) $(call CSRC,$(WOW_DIR)/game) $(call CSRC,$(WOW_DIR)/serverdata),game-wow,$(WOW_DIR)/game $(WOW_DIR)/serverdata,,$(WOW_CFLAGS),common/mpq.c,-lshared $(LIBS) -lm -lz))
...
$(eval $(call unity_lib_schema,$(GAME_WOW_TEST_LIB),$(GAME_BASE_DEPS) common/world.c $(WOW_COMMON_SRCS) $(call CSRC,$(WOW_DIR)/game) $(call CSRC,$(WOW_DIR)/serverdata),game-wow-test,$(WOW_DIR)/game $(WOW_DIR)/serverdata,,$(WOW_CFLAGS) -DBZ_TESTS,common/mpq.c,-lshared $(LIBS) -lm -lz))
