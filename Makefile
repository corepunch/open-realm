...
$(eval $(call test_schema,test-wow-game,,$(WOW_TEST_CFLAGS),$(BIN_DIR)/test_wow_game$(EXE_EXT),tests/test_runner.c $(WOW_TEST_DIR)/test_wow_game.c $(WOW_DIR)/game/g_wow.c $(WOW_DIR)/game/g_world.c $(WOW_DIR)/game/g_ai.c $(WOW_DIR)/game/m_creature.c $(WOW_DIR)/game/g_wow_gameobject.c $(WOW_DIR)/game/g_spawn.c serverdata/world-of-warcraft/wow_weapon_data.c serverdata/world-of-warcraft/wow_quest_data.c common/mpq.c $(call CSRC,shared),-lm -lz,))
