...
- Orc worker-inside, Night Elf worker/Ancient consumption, and Undead summon/release construction strategies are implemented; Haunted/Entangled Mine overlays and authoritative Blight placement are implemented, while Blight presentation/client sync, Wisp lumber, and full Root/Uproot remain tracked in [Race Mechanics](race-mechanics.md) and [Blight](blight.md);
