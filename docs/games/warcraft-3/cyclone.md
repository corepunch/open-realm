...
locks, ROC empty-BuffID → `Bcyc`, HeroDur vs Dur, expiry restore, recast, and
DataA dispel eligibility (non-stock DataA≠0 removed by Adis/Purge; DataA=0
survives while other buffs and mana spend still apply).
